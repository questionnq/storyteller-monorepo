  ...
  <div>
    <main class="container mx-auto px-4 py-4 max-w-5xl">
      ...
      <div class="bg-base-200 rounded-lg p-6 shadow-lg mb-6">
        ...
        <!-- DEBUG INFO -->
        <div class="mb-4 p-3 bg-base-300 rounded text-xs font-mono">
          <div><strong>Status:</strong> {{ status }}</div>
          <div><strong>VideoURL:</strong> {{ videoUrl ? videoUrl.substring(0, 60) + '...' : 'null' }}</div>
          <div><strong>Has Images:</strong> {{ hasGeneratedImages }}</div>
        </div>
